...
%\mu: used to balance two goals: matching corresponding pairs and preserving manifold topology.   
   ...
   W=sparse((D21))*W*sparse((D21));
    ...
    [ev, ea]=eigs(full(I-W),DimLatentSpace,'SM');
    ...
    g1=ev(1:n1,start:DimLatentSpace+start-1);
    g2=ev(n1+1:n1+n2, start:DimLatentSpace+start-1);
    g3=ev(n1+n2+1:n1+n2+n3, start:DimLatentSpace+start-1);
end
